        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          ...
          <Select value={sort} onValueChange={(v: string | null) => setSort(v ?? 'rating')}>
            ...
            <SelectContent>
              ...
              <SelectItem value="price">Lowest Price (TND)</SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        <div className="flex gap-2 flex-wrap mb-8">
          {CATEGORIES.map(c => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${category === c ? 'bg-emerald-600 text-white shadow-md' : 'bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700 hover:border-emerald-300'}`}
            >
              {c}
            </button>
          ))}
            ...
            <>
              ...
              <div className="p-6">
                <DialogHeader className="mb-4">
                  ...
                  <p className="text-gray-500 flex items-center gap-1"><MapPin className="w-4 h-4" /> {selected.location}, {selected.country}</p>
                </DialogHeader>
